...
import { fetchGeneratedImages } from "@/redux/reducers/images";
...
const AIArtPage = () => {
  ...
  //   //   console.log(currentImgFPs);
  //   //   setImgFilePaths(currentImgFPs);
  //   //   console.log(imageFPs);
  //   //   const currentJSONImgs = await getCurrentJSON();
  ...
  console.log(state.generatedImages);
  return (
    <MainContainer>
      <div className={styles.aiGenContainer}>
        <div className={styles.aiGenContent}>
          ...
          <div className={styles.recentGensContainer}>
            ...
            {state.generatedImages.map((item, index) => {
              return (
